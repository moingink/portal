				...
				<div class="login-info">
					...
					<div class="login-info">
						...
						<div class="login-list">
							...
							<p class="name-input"><input type="password" placeholder="请输入密码" name='password' id="password"/></p>
						</div>
						<div class="login-list">
						...
						<div class="new-pwd">
							<p class="pwd-btn">找回密码</p>
							<p class="pwd-input"><input type="text" name="" id="" value=""  placeholder="手机或者邮箱 "/></p>
						</div>
					</div>
				</div>
