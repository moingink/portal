...
<html lang="zh-cn">
	...
	<body>
					...
					<div class="panel panel-primary">
						...
						<div class="panel-body">
							...
							<div id="toolbar">
								...
								<button type="button" class="btn btn-default" onclick="queryTable()">
									<span class="glyphicon glyphicon-search" aria-hidden="true">查询
								</button>
								<button type="button" class="btn btn-default" onclick="tog()">
									<span class="glyphicon glyphicon-plus" aria-hidden="true">新增
								</button>
								<button type="button" class="btn btn-default" onclick="updateRow()">
									<span class="glyphicon glyphicon-pencil" aria-hidden="true">修改
								</button>
								<button type="button" class="btn btn-default" onclick="delRows()">
									<span class="glyphicon glyphicon-remove" aria-hidden="true"></span>删除
								</button>
								<button type="button" class="btn btn-default" onclick="findCheckMessage()">
									检查数据
								</button>
							</div>
		...
		<!--主表主键 FOR 查询-->
		<input type="hidden" id="SEARCH-%3D-CODE_TYPE_ID">
		...
		<script>
			...
			$(function() {
				$("[id='SEARCH-%3D-CODE_TYPE_ID'],#CODE_TYPE_ID").val(getURLParameter("CODE_TYPE_ID"));
				bulidTable();
			});
