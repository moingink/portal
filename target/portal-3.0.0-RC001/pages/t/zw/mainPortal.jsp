			...
			<div class="index_top">
				<div class="row">
					<div class="col-xs-8 hidden-xs">
						<ul class="clearfix ">
							<li style="color: red;"><%=loginName%></li>
							<li class="hidden-md hidden-xs">您好，欢迎来到联通智网科技业务管理系统</li>
							<li id="companyLi" class="hidden-xs border-none"><%=corpName%></li>
							
						</ul>
					</div>
					<div class="col-xs-4">
						<a class="pull-right" href="<%=request.getContextPath()%>/login/signOut?token=<%=token%>">退出</a>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="footer">
		<div class="container">
			<div class="table_cell">
				<ul class="clearfix">
					<li>法律声明&nbsp|&nbsp站点导航&nbsp|&nbsp联系我们</li>
				</ul>
			</div>
			<p>联通智网版权所有</p>
		</div>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-modal" data-dismiss="modal">关闭
					</button>
				</div>
			</div>
			<!-- /.modal-content -->
