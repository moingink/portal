		  ...
		  <div class="carousel_r">
		  	<div class="backlog">
				...
				<ul>
					...
					<li>
			        	<dl>
			        		<dt><img src="img/02.jpg" alt="" id="more" style="cursor:pointer"></dt>
		...
		<div class="container item-wrap">
			<div class="item_box">
				<ul class="item_scroll clearfix" id="pr" >
					<li>
						<p class='top'>客户资源专项工作</p>
						<p class='pic'><img src="<%=ThemePath.findRoute(request) %>img/41.png" alt="系统建设中" ></p>
						
					</li>
					<li>
						<p class='top'>供应商管理专项工作</p>
						<p class='pic'><img src="<%=ThemePath.findRoute(request) %>img/42.png" alt="系统建设中" ></p>
					</li>
					<li>
						<p class='top'>项目实施专项工作</p>
						<p class='pic'><img src="<%=ThemePath.findRoute(request) %>img/43.png" alt="系统建设中" ></p>
					<li>
						<p class='top'>财务计收专项工作</p>
						<p class='pic'><img src="<%=ThemePath.findRoute(request) %>img/44.png" alt="系统建设中" ></p>
					</li>
					<li>
						<p class='top'>账号年检专项工作</p>
						<p class='pic'><img src="<%=ThemePath.findRoute(request) %>img/51.png" alt="系统建设中" ></p>
					</li>
					<li>
						<p class='top'>季度预算专项公司</p>
						<p class='pic'><img src="<%=ThemePath.findRoute(request) %>img/52.png" alt="系统建设中" ></p>
					</li>
				</ul>
				<p class="left_btn">&lt;</p>
				<p class="right_btn">&gt;</p>
