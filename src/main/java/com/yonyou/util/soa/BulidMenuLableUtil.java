...
public class BulidMenuLableUtil {
	 ...
	 * @return
	 */
	public static String bulidMenuLableForA(Map<String,List<MenuEntity>> menuData,String menuCode){
		int showLength=6;
	 ...
	 * @return
	 */
	public static String bulidMenuByMenuCode(Map<String,List<MenuEntity>> menuData,String menuCode,String mark){
	 ...
	 * @return
	 */
	public static String bulidMenuLableForB(Map<String,List<MenuEntity>> menuData,String menuCode){
	 ...
	 * @return
	 */
	public static String bulidMenuLableForNode(Map<String,List<MenuEntity>> menuData,String menuCode,String style,int iterationLength){
	...
	private static String findMarkString(int iterationLength){
		String mark="";
	...
	private static String decorateName(String name){
