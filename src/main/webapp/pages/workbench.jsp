		...
		<div class="container item-wrap">
			<div class="item_box">
				<ul class="item_scroll clearfix" id="pr" >
					<li>
						<img src="<%=ContextPath%>/images/item_new_0.png" alt="系统建设中" >
					</li>
					<li>
						<img src="<%=ContextPath%>/images/item_new_1.png" alt="系统建设中" >
					</li>
					<li>
						<img src="<%=ContextPath%>/images/item_new_2.png" alt="系统建设中" >
					</li>
					<li>
						<img src="<%=ContextPath%>/images/item_new_3.png" alt="系统建设中" >
					</li>
					<li>
						<img src="<%=ContextPath%>/images/item_new_1.png" alt="系统建设中" >
					</li>
