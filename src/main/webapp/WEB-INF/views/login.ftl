		  ...
		  <div class="col-xs-6 row_r">
		  	<div class="login_box">
		  		...
		  		<div class="login_name form-group">
					...
					<input type="text" name="username" maxlength="50" value="ceshi1" id="username" class="user_input form-control"  />
		  		</div>
		  		<div class="login_password form-group">
		  			<label for="password" class="label_password">密码</label>
					<input type="password" name="password" maxlength="50" value="gur6h8mt" id="password" class="password_input form-control" />
		  		</div>
